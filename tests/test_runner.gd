...
## SceneTree test runner entry point executing all test suites in headless CLI mode.
func _init():
	print("\n===========================================================")
	...
	var square_tests = TestSquareRules.new()
	...
	var logic_tests = TestGameLogic.new()
	...
	var coverage_engine = TestCoverage.new()
