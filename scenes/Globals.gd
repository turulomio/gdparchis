...
func position3(square_id: int, square_position: int, h: float = 0.2) -> Vector3:
	match square_id:
		1: return [Vector3(-7.35, h, -22.05), Vector3(-6.15, h, -20.85)][square_position]
		2: return [Vector3(-7.35, h, -18.90), Vector3(-6.15, h, -17.70)][square_position]
		3: return [Vector3(-7.35, h, -15.75), Vector3(-6.15, h, -14.55)][square_position]
		4: return [Vector3(-7.35, h, -12.60), Vector3(-6.15, h, -11.40)][square_position]
		5: return [Vector3(-7.35, h, -9.45), Vector3(-6.15, h, -8.25)][square_position]
		6: return [Vector3(-7.35, h, -6.30), Vector3(-6.15, h, -5.10)][square_position]
		7: return [Vector3(-7.35, h, -3.15), Vector3(-6.15, h, -1.95)][square_position]
		8: return [Vector3(-7.35, h, -0.00), Vector3(-6.15, h, 1.20)][square_position]
		9: return [Vector3(-3.68, h, 6.37), Vector3(-2.48, h, 7.57)][square_position]
		10: return [Vector3(-6.40, h, 7.94), Vector3(-5.20, h, 9.14)][square_position]
		11: return [Vector3(-9.13, h, 9.52), Vector3(-7.93, h, 10.72)][square_position]
		12: return [Vector3(-11.86, h, 11.09), Vector3(-10.66, h, 12.29)][square_position]
		13: return [Vector3(-14.59, h, 12.67), Vector3(-13.39, h, 13.87)][square_position]
		14: return [Vector3(-17.31, h, 14.24), Vector3(-16.11, h, 15.44)][square_position]
		15: return [Vector3(-20.04, h, 15.82), Vector3(-18.84, h, 17.02)][square_position]
		16: return [Vector3(-22.77, h, 17.39), Vector3(-21.57, h, 18.59)][square_position]
		17: return [Vector3(-19.10, h, 23.76), Vector3(-17.90, h, 24.96)][square_position]
		18: return [Vector3(-15.42, h, 30.12), Vector3(-14.22, h, 31.32)][square_position]
		19: return [Vector3(-12.69, h, 28.55), Vector3(-11.49, h, 29.75)][square_position]
		20: return [Vector3(-9.96, h, 26.97), Vector3(-8.76, h, 28.17)][square_position]
		21: return [Vector3(-7.24, h, 25.40), Vector3(-6.04, h, 26.60)][square_position]
		22: return [Vector3(-4.51, h, 23.82), Vector3(-3.31, h, 25.02)][square_position]
		23: return [Vector3(-1.78, h, 22.25), Vector3(-0.58, h, 23.45)][square_position]
		24: return [Vector3(0.95, h, 20.67), Vector3(2.15, h, 21.87)][square_position]
		25: return [Vector3(3.68, h, 19.10), Vector3(4.88, h, 20.30)][square_position]
		26: return [Vector3(7.35, h, 12.73), Vector3(8.55, h, 13.93)][square_position]
		27: return [Vector3(10.08, h, 14.31), Vector3(11.28, h, 15.51)][square_position]
		28: return [Vector3(12.81, h, 15.88), Vector3(14.01, h, 17.08)][square_position]
		29: return [Vector3(15.53, h, 17.46), Vector3(16.73, h, 18.66)][square_position]
		30: return [Vector3(18.26, h, 19.03), Vector3(19.46, h, 20.23)][square_position]
		31: return [Vector3(20.99, h, 20.61), Vector3(22.19, h, 21.81)][square_position]
		32: return [Vector3(23.72, h, 22.18), Vector3(24.92, h, 23.38)][square_position]
		33: return [Vector3(26.45, h, 23.76), Vector3(27.65, h, 24.96)][square_position]
		34: return [Vector3(30.12, h, 17.39), Vector3(31.32, h, 18.59)][square_position]
		35: return [Vector3(33.80, h, 11.03), Vector3(35.00, h, 12.22)][square_position]
		36: return [Vector3(31.07, h, 9.45), Vector3(32.27, h, 10.65)][square_position]
		37: return [Vector3(28.34, h, 7.88), Vector3(29.54, h, 9.07)][square_position]
		38: return [Vector3(25.61, h, 6.30), Vector3(26.81, h, 7.50)][square_position]
		39: return [Vector3(22.88, h, 4.73), Vector3(24.08, h, 5.93)][square_position]
		40: return [Vector3(20.16, h, 3.15), Vector3(21.36, h, 4.35)][square_position]
		41: return [Vector3(17.43, h, 1.58), Vector3(18.63, h, 2.78)][square_position]
		42: return [Vector3(14.70, h, -0.00), Vector3(15.90, h, 1.20)][square_position]
		43: return [Vector3(7.35, h, -0.00), Vector3(8.55, h, 1.20)][square_position]
		44: return [Vector3(7.35, h, -3.15), Vector3(8.55, h, -1.95)][square_position]
		45: return [Vector3(7.35, h, -6.30), Vector3(8.55, h, -5.10)][square_position]
		46: return [Vector3(7.35, h, -9.45), Vector3(8.55, h, -8.25)][square_position]
		47: return [Vector3(7.35, h, -12.60), Vector3(8.55, h, -11.40)][square_position]
		48: return [Vector3(7.35, h, -15.75), Vector3(8.55, h, -14.55)][square_position]
		49: return [Vector3(7.35, h, -18.90), Vector3(8.55, h, -17.70)][square_position]
		50: return [Vector3(7.35, h, -22.05), Vector3(8.55, h, -20.85)][square_position]
		51: return [Vector3(0.00, h, -22.05), Vector3(1.20, h, -20.85)][square_position]
		52: return [Vector3(0.00, h, -18.90), Vector3(1.20, h, -17.70)][square_position]
		53: return [Vector3(0.00, h, -15.75), Vector3(1.20, h, -14.55)][square_position]
		54: return [Vector3(0.00, h, -12.60), Vector3(1.20, h, -11.40)][square_position]
		55: return [Vector3(0.00, h, -9.45), Vector3(1.20, h, -8.25)][square_position]
		56: return [Vector3(0.00, h, -6.30), Vector3(1.20, h, -5.10)][square_position]
		57: return [Vector3(0.00, h, -3.15), Vector3(1.20, h, -1.95)][square_position]
		58: return [Vector3(0.00, h, -0.00), Vector3(1.20, h, 1.20)][square_position]
		59: return [Vector3(0.00, h, -0.00), Vector3(1.20, h, 1.20)][square_position]
		60: return [Vector3(-16.37, h, 22.18), Vector3(-15.17, h, 23.38)][square_position]
		61: return [Vector3(-13.64, h, 20.61), Vector3(-12.44, h, 21.81)][square_position]
		62: return [Vector3(-10.91, h, 19.03), Vector3(-9.71, h, 20.23)][square_position]
		63: return [Vector3(-8.18, h, 17.46), Vector3(-6.98, h, 18.66)][square_position]
		64: return [Vector3(-5.46, h, 15.88), Vector3(-4.26, h, 17.08)][square_position]
		65: return [Vector3(-2.73, h, 14.31), Vector3(-1.53, h, 15.51)][square_position]
		66: return [Vector3(0.00, h, 12.73), Vector3(1.20, h, 13.93)][square_position]
		67: return [Vector3(0.00, h, -0.00), Vector3(1.20, h, 1.20)][square_position]
		68: return [Vector3(27.39, h, 15.82), Vector3(28.59, h, 17.02)][square_position]
		69: return [Vector3(24.66, h, 14.24), Vector3(25.86, h, 15.44)][square_position]
		70: return [Vector3(21.94, h, 12.67), Vector3(23.14, h, 13.87)][square_position]
		71: return [Vector3(19.21, h, 11.09), Vector3(20.41, h, 12.29)][square_position]
		72: return [Vector3(16.48, h, 9.52), Vector3(17.68, h, 10.72)][square_position]
		73: return [Vector3(13.75, h, 7.94), Vector3(14.95, h, 9.14)][square_position]
		74: return [Vector3(11.03, h, 6.37), Vector3(12.22, h, 7.57)][square_position]
		75: return [Vector3(0.00, h, -0.00), Vector3(1.20, h, 1.20)][square_position]
		76: return [Vector3(-7.28, h, -12.53), Vector3(-4.28, h, -12.53), Vector3(-7.28, h, -9.53), Vector3(-4.28, h, -9.53)][square_position]
		77: return [Vector3(-1.50, h, 13.20), Vector3(1.50, h, 13.20), Vector3(-1.50, h, 16.20), Vector3(1.50, h, 16.20)][square_position]
		78: return [Vector3(4.28, h, -12.53), Vector3(7.28, h, -12.53), Vector3(4.28, h, -9.53), Vector3(7.28, h, -9.53)][square_position]
		_:
