...
func _ready() -> void:
	...
	if OS.get_name() == "Android" or OS.has_feature("android") or OS.has_feature("mobile"):
		...
		# Hide remaining desktop keyboard/mouse control labels (Ctrl6 through Ctrl18)
		for i in range(6, 19):
		...
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl6.text = tr("F1: Yellow Player Camera View (Perspective)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl7.text = tr("F2: Blue Player Camera View (Perspective)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl8.text = tr("F3: Red Player Camera View (Perspective)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl9.text = tr("F4: Green Player Camera View (Perspective)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl10.text = tr("Shift + F1: Yellow Player Camera View (Floor Level)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl11.text = tr("Shift + F2: Blue Player Camera View (Floor Level)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl12.text = tr("Shift + F3: Red Player Camera View (Floor Level)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl13.text = tr("Shift + F4: Green Player Camera View (Floor Level)")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl14.text = tr("F9: Bottom Camera View")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl15.text = tr("F10 / Enter: Top Camera View")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl16.text = tr("F11 / Key F: Toggle Fullscreen Mode")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl17.text = tr("Esc: Back to Main Menu / Exit")
		$MarginContainer/VBoxContainer/ScrollContainer/ControlsList/Ctrl18.text = tr("Key S: Toggle Sound ON / OFF")
